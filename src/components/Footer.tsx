...
const Footer = () => (
  <footer style={{ background: '#210706', color: '#F1E6D2', padding: '2rem 0', textAlign: 'center', marginTop: '3rem', fontSize: 18 }}>
    <div style={{ maxWidth: 1200, margin: '0 auto', lineHeight: 1.7 }}>
      ...
      Correo: <a href="mailto:contacto@arxsoftware.com" style={{color:'#F1E6D2', textDecoration: 'underline'}}>contacto@arxsoftware.com</a> | 
      Tel: <a href="tel:+52961XXXXXXX" style={{color:'#F1E6D2', textDecoration: 'underline'}}>+52 961 XXX XXXX</a> <br/>
